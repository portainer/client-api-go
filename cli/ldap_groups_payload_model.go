...
// Schema cli for LdapGroupsPayload

// register flags to command
func registerModelLdapGroupsPayloadFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerLdapGroupsPayloadLdapsettings(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerLdapGroupsPayloadLdapsettings(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelLdapGroupsPayloadFlags(depth int, m *models.LdapGroupsPayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, ldapsettingsAdded := retrieveLdapGroupsPayloadLdapsettingsFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveLdapGroupsPayloadLdapsettingsFlags(depth int, m *models.LdapGroupsPayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
