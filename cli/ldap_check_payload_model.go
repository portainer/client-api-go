...
// Schema cli for LdapCheckPayload

// register flags to command
func registerModelLdapCheckPayloadFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerLdapCheckPayloadLdapsettings(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerLdapCheckPayloadLdapsettings(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelLdapCheckPayloadFlags(depth int, m *models.LdapCheckPayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, ldapsettingsAdded := retrieveLdapCheckPayloadLdapsettingsFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveLdapCheckPayloadLdapsettingsFlags(depth int, m *models.LdapCheckPayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
