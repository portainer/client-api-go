...
// Schema cli for UsersThemePayload

// register flags to command
func registerModelUsersThemePayloadFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerUsersThemePayloadColor(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerUsersThemePayloadSubtleUpgradeButton(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerUsersThemePayloadColor(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerUsersThemePayloadSubtleUpgradeButton(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelUsersThemePayloadFlags(depth int, m *models.UsersThemePayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, colorAdded := retrieveUsersThemePayloadColorFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || colorAdded

	err, subtleUpgradeButtonAdded := retrieveUsersThemePayloadSubtleUpgradeButtonFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveUsersThemePayloadColorFlags(depth int, m *models.UsersThemePayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveUsersThemePayloadSubtleUpgradeButtonFlags(depth int, m *models.UsersThemePayload, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
