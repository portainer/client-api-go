...
type EndpointGroupUpdateParams struct {
	...
	*/
	Body *models.EndpointgroupsEndpointGroupUpdatePayload
...
func (o *EndpointGroupUpdateParams) WithBody(body *models.EndpointgroupsEndpointGroupUpdatePayload) *EndpointGroupUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint group update params
func (o *EndpointGroupUpdateParams) SetBody(body *models.EndpointgroupsEndpointGroupUpdatePayload) {
	o.Body = body
}
