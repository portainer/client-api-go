...
func (m *PortainerEndpoint) validateGpus(formats strfmt.Registry) error {
...
func (m *PortainerEndpoint) validatePostInitMigrations(formats strfmt.Registry) error {
...
func (m *PortainerEndpoint) validateAgent(formats strfmt.Registry) error {
...
func (m *PortainerEndpoint) contextValidateGpus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PortainerEndpoint) contextValidatePostInitMigrations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PortainerEndpoint) contextValidateAgent(ctx context.Context, formats strfmt.Registry) error {
...
// PortainerEndpointAgent portainer endpoint agent
//
// swagger:model PortainerEndpointAgent
type PortainerEndpointAgent struct {
...
// Validate validates this portainer endpoint agent
func (m *PortainerEndpointAgent) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this portainer endpoint agent based on context it is used
func (m *PortainerEndpointAgent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PortainerEndpointAgent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *PortainerEndpointAgent) UnmarshalBinary(b []byte) error {
	var res PortainerEndpointAgent
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
