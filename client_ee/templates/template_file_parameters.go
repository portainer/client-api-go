...
type TemplateFileParams struct {
	...
	/* Body.
	   ...
	   File details
	*/
	Body *models_ee.TemplatesFilePayload
...
func (o *TemplateFileParams) WithBody(body *models_ee.TemplatesFilePayload) *TemplateFileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the template file params
func (o *TemplateFileParams) SetBody(body *models_ee.TemplatesFilePayload) {
	o.Body = body
}
