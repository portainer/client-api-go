...
type UserGenerateAPIKeyCreated struct {
	Payload *models_ee.UsersAccessTokenResponse
}
...
func (o *UserGenerateAPIKeyCreated) GetPayload() *models_ee.UsersAccessTokenResponse {
	return o.Payload
}
...
func (o *UserGenerateAPIKeyCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.UsersAccessTokenResponse)
