...
type UserUpdatePasswordParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.UsersUserUpdatePasswordPayload
...
func (o *UserUpdatePasswordParams) WithBody(body *models_ee.UsersUserUpdatePasswordPayload) *UserUpdatePasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user update password params
func (o *UserUpdatePasswordParams) SetBody(body *models_ee.UsersUserUpdatePasswordPayload) {
	o.Body = body
}
