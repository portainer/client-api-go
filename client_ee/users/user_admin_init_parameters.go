...
type UserAdminInitParams struct {
	...
	/* Body.
	   ...
	   User details
	*/
	Body *models_ee.UsersAdminInitPayload
...
func (o *UserAdminInitParams) WithBody(body *models_ee.UsersAdminInitPayload) *UserAdminInitParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user admin init params
func (o *UserAdminInitParams) SetBody(body *models_ee.UsersAdminInitPayload) {
	o.Body = body
}
