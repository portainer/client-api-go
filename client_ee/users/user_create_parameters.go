...
type UserCreateParams struct {
	...
	/* Body.
	   ...
	   User details
	*/
	Body *models_ee.UsersUserCreatePayload
...
func (o *UserCreateParams) WithBody(body *models_ee.UsersUserCreatePayload) *UserCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user create params
func (o *UserCreateParams) SetBody(body *models_ee.UsersUserCreatePayload) {
	o.Body = body
}
