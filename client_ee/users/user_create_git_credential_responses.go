...
type UserCreateGitCredentialCreated struct {
	Payload *models_ee.UsersGitCredentialResponse
}
...
func (o *UserCreateGitCredentialCreated) GetPayload() *models_ee.UsersGitCredentialResponse {
	return o.Payload
}
...
func (o *UserCreateGitCredentialCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.UsersGitCredentialResponse)
