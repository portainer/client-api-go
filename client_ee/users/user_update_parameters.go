...
type UserUpdateParams struct {
	...
	/* Body.
	   ...
	   User details
	*/
	Body *models_ee.UsersUserUpdatePayload
...
func (o *UserUpdateParams) WithBody(body *models_ee.UsersUserUpdatePayload) *UserUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user update params
func (o *UserUpdateParams) SetBody(body *models_ee.UsersUserUpdatePayload) {
	o.Body = body
}
