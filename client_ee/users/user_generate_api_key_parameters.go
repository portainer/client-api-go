...
type UserGenerateAPIKeyParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.UsersUserAccessTokenCreatePayload
...
func (o *UserGenerateAPIKeyParams) WithBody(body *models_ee.UsersUserAccessTokenCreatePayload) *UserGenerateAPIKeyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user generate API key params
func (o *UserGenerateAPIKeyParams) SetBody(body *models_ee.UsersUserAccessTokenCreatePayload) {
	o.Body = body
}
