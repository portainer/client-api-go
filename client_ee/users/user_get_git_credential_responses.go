...
type UserGetGitCredentialOK struct {
	Payload *models_ee.PortainereeGitCredential
}
...
func (o *UserGetGitCredentialOK) GetPayload() *models_ee.PortainereeGitCredential {
	return o.Payload
}
...
func (o *UserGetGitCredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PortainereeGitCredential)
