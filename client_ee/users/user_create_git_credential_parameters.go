...
type UserCreateGitCredentialParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.UsersUserGitCredentialCreatePayload
...
func (o *UserCreateGitCredentialParams) WithBody(body *models_ee.UsersUserGitCredentialCreatePayload) *UserCreateGitCredentialParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user create git credential params
func (o *UserCreateGitCredentialParams) SetBody(body *models_ee.UsersUserGitCredentialCreatePayload) {
	o.Body = body
}
