...
type GetKubernetesPodSecurityRuleOK struct {
	Payload *models_ee.PodsecurityPodSecurityRule
}
...
func (o *GetKubernetesPodSecurityRuleOK) GetPayload() *models_ee.PodsecurityPodSecurityRule {
	return o.Payload
}
...
func (o *GetKubernetesPodSecurityRuleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PodsecurityPodSecurityRule)
