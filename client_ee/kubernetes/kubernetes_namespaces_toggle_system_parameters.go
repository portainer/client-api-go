...
type KubernetesNamespacesToggleSystemParams struct {
	...
	/* Body.
	   ...
	   Update details
	*/
	Body *models_ee.KubernetesNamespacesToggleSystemPayload
...
func (o *KubernetesNamespacesToggleSystemParams) WithBody(body *models_ee.KubernetesNamespacesToggleSystemPayload) *KubernetesNamespacesToggleSystemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the kubernetes namespaces toggle system params
func (o *KubernetesNamespacesToggleSystemParams) SetBody(body *models_ee.KubernetesNamespacesToggleSystemPayload) {
	o.Body = body
}
