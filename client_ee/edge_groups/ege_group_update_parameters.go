...
type EgeGroupUpdateParams struct {
	...
	/* Body.
	   ...
	   EdgeGroup data
	*/
	Body *models_ee.EdgegroupsEdgeGroupUpdatePayload
...
func (o *EgeGroupUpdateParams) WithBody(body *models_ee.EdgegroupsEdgeGroupUpdatePayload) *EgeGroupUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the ege group update params
func (o *EgeGroupUpdateParams) SetBody(body *models_ee.EdgegroupsEdgeGroupUpdatePayload) {
	o.Body = body
}
