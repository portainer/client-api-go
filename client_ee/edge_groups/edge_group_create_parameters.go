...
type EdgeGroupCreateParams struct {
	...
	/* Body.
	   ...
	   EdgeGroup data
	*/
	Body *models_ee.EdgegroupsEdgeGroupCreatePayload
...
func (o *EdgeGroupCreateParams) WithBody(body *models_ee.EdgegroupsEdgeGroupCreatePayload) *EdgeGroupCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge group create params
func (o *EdgeGroupCreateParams) SetBody(body *models_ee.EdgegroupsEdgeGroupCreatePayload) {
	o.Body = body
}
