...
type EcrDeleteTagsParams struct {
	...
	/* Body.
	   ...
	   Tag Array
	*/
	Body *models_ee.RegistriesDeleteTagsPayload
...
func (o *EcrDeleteTagsParams) WithBody(body *models_ee.RegistriesDeleteTagsPayload) *EcrDeleteTagsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the ecr delete tags params
func (o *EcrDeleteTagsParams) SetBody(body *models_ee.RegistriesDeleteTagsPayload) {
	o.Body = body
}
