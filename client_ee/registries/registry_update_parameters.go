...
type RegistryUpdateParams struct {
	...
	/* Body.
	   ...
	   Registry details
	*/
	Body *models_ee.RegistriesRegistryUpdatePayload
...
func (o *RegistryUpdateParams) WithBody(body *models_ee.RegistriesRegistryUpdatePayload) *RegistryUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the registry update params
func (o *RegistryUpdateParams) SetBody(body *models_ee.RegistriesRegistryUpdatePayload) {
	o.Body = body
}
