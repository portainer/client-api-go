...
type RegistryConfigureParams struct {
	...
	*/
	Body *models_ee.RegistriesRegistryConfigurePayload
...
func (o *RegistryConfigureParams) WithBody(body *models_ee.RegistriesRegistryConfigurePayload) *RegistryConfigureParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the registry configure params
func (o *RegistryConfigureParams) SetBody(body *models_ee.RegistriesRegistryConfigurePayload) {
	o.Body = body
}
