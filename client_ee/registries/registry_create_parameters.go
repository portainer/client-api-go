...
type RegistryCreateParams struct {
	...
	/* Body.
	   ...
	   Registry details
	*/
	Body *models_ee.RegistriesRegistryCreatePayload
...
func (o *RegistryCreateParams) WithBody(body *models_ee.RegistriesRegistryCreatePayload) *RegistryCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the registry create params
func (o *RegistryCreateParams) SetBody(body *models_ee.RegistriesRegistryCreatePayload) {
	o.Body = body
}
