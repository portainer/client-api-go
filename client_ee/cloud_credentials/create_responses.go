...
type CreateOK struct {
	Payload *models_ee.ModelsCloudCredential
}
...
func (o *CreateOK) Error() string {
	return fmt.Sprintf("[POST /cloudcredentials][%d] createOK  %+v", 200, o.Payload)
}
...
func (o *CreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /cloudcredentials][%d] createBadRequest ", 400)
}
...
func (o *CreateInternalServerError) Error() string {
	return fmt.Sprintf("[POST /cloudcredentials][%d] createInternalServerError ", 500)
}
