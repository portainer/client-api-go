...
type AuthLogsListOK struct {
	Payload []*models_ee.PortainereeAuthActivityLog
}
...
func (o *AuthLogsListOK) Error() string {
	return fmt.Sprintf("[GET /useractivity/authlogs][%d] authLogsListOK  %+v", 200, o.Payload)
}
...
func (o *AuthLogsListOK) GetPayload() []*models_ee.PortainereeAuthActivityLog {
	return o.Payload
}
