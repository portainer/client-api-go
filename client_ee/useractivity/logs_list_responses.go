...
type LogsListOK struct {
	Payload *models_ee.UseractivityLogsListResponse
}
...
func (o *LogsListOK) GetPayload() *models_ee.UseractivityLogsListResponse {
	return o.Payload
}

func (o *LogsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models_ee.UseractivityLogsListResponse)
