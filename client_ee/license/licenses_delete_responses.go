...
type LicensesDeleteOK struct {
	Payload *models_ee.LicensesDeleteResponse
}
...
func (o *LicensesDeleteOK) GetPayload() *models_ee.LicensesDeleteResponse {
	return o.Payload
}
...
func (o *LicensesDeleteOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.LicensesDeleteResponse)
