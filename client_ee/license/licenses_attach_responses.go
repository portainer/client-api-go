...
type LicensesAttachOK struct {
	Payload *models_ee.LicensesAttachResponse
}
...
func (o *LicensesAttachOK) GetPayload() *models_ee.LicensesAttachResponse {
	return o.Payload
}
...
func (o *LicensesAttachOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.LicensesAttachResponse)
