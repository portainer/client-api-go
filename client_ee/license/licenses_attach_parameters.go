...
type LicensesAttachParams struct {
	...
	*/
	Body *models_ee.LicensesAttachPayload
...
func (o *LicensesAttachParams) WithBody(body *models_ee.LicensesAttachPayload) *LicensesAttachParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the licenses attach params
func (o *LicensesAttachParams) SetBody(body *models_ee.LicensesAttachPayload) {
	o.Body = body
}
