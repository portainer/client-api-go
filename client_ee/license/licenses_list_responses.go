...
type LicensesListOK struct {
	Payload []*models_ee.LiblicensePortainerLicense
}
...
func (o *LicensesListOK) Error() string {
	return fmt.Sprintf("[GET /licenses][%d] licensesListOK  %+v", 200, o.Payload)
}
...
func (o *LicensesListOK) GetPayload() []*models_ee.LiblicensePortainerLicense {
	return o.Payload
}
