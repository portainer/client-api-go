...
type LicensesDeleteParams struct {
	...
	*/
	Body *models_ee.LicensesDeletePayload
...
func (o *LicensesDeleteParams) WithBody(body *models_ee.LicensesDeletePayload) *LicensesDeleteParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the licenses delete params
func (o *LicensesDeleteParams) SetBody(body *models_ee.LicensesDeletePayload) {
	o.Body = body
}
