...
type TeamCreateParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.TeamsTeamCreatePayload
...
func (o *TeamCreateParams) WithBody(body *models_ee.TeamsTeamCreatePayload) *TeamCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team create params
func (o *TeamCreateParams) SetBody(body *models_ee.TeamsTeamCreatePayload) {
	o.Body = body
}
