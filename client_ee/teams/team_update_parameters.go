...
type TeamUpdateParams struct {
	...
	/* Body.
	   ...
	   Team details
	*/
	Body *models_ee.TeamsTeamUpdatePayload
...
func (o *TeamUpdateParams) WithBody(body *models_ee.TeamsTeamUpdatePayload) *TeamUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team update params
func (o *TeamUpdateParams) SetBody(body *models_ee.TeamsTeamUpdatePayload) {
	o.Body = body
}
