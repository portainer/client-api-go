...
type SSLUpdateParams struct {
	...
	/* Body.
	   ...
	   SSL Settings
	*/
	Body *models_ee.SslSslUpdatePayload
...
func (o *SSLUpdateParams) WithBody(body *models_ee.SslSslUpdatePayload) *SSLUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the s s l update params
func (o *SSLUpdateParams) SetBody(body *models_ee.SslSslUpdatePayload) {
	o.Body = body
}
