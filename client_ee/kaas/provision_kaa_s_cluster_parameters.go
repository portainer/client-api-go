...
func (o *ProvisionKaaSClusterParams) WithBodyAmazon(bodyAmazon *models_ee.ProvidersAmazonProvisionPayload) *ProvisionKaaSClusterParams {
	o.SetBodyAmazon(bodyAmazon)
	return o
}

// SetBodyAmazon adds the bodyAmazon to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) SetBodyAmazon(bodyAmazon *models_ee.ProvidersAmazonProvisionPayload) {
	o.BodyAmazon = bodyAmazon
}

// WithBodyAPI adds the bodyAPI to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) WithBodyAPI(bodyAPI *models_ee.ProvidersDefaultProvisionPayload) *ProvisionKaaSClusterParams {
	o.SetBodyAPI(bodyAPI)
	return o
}

// SetBodyAPI adds the bodyApi to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) SetBodyAPI(bodyAPI *models_ee.ProvidersDefaultProvisionPayload) {
	o.BodyAPI = bodyAPI
}

// WithBodyAzure adds the bodyAzure to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) WithBodyAzure(bodyAzure *models_ee.ProvidersAzureProvisionPayload) *ProvisionKaaSClusterParams {
	o.SetBodyAzure(bodyAzure)
	return o
}

// SetBodyAzure adds the bodyAzure to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) SetBodyAzure(bodyAzure *models_ee.ProvidersAzureProvisionPayload) {
	o.BodyAzure = bodyAzure
}

// WithBodyGke adds the bodyGke to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) WithBodyGke(bodyGke *models_ee.ProvidersGKEProvisionPayload) *ProvisionKaaSClusterParams {
	o.SetBodyGke(bodyGke)
	return o
}

// SetBodyGke adds the bodyGke to the provision kaa s cluster params
func (o *ProvisionKaaSClusterParams) SetBodyGke(bodyGke *models_ee.ProvidersGKEProvisionPayload) {
	o.BodyGke = bodyGke
}
