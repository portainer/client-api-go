...
type SystemVersionOK struct {
	Payload *models_ee.GithubComPortainerPortainerEeAPIHTTPHandlerSystemVersionResponse
}
...
func (o *SystemVersionOK) GetPayload() *models_ee.GithubComPortainerPortainerEeAPIHTTPHandlerSystemVersionResponse {
	return o.Payload
}
...
func (o *SystemVersionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.GithubComPortainerPortainerEeAPIHTTPHandlerSystemVersionResponse)
