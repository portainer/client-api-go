...
type SystemUpgradeOK struct {
	Payload *models_ee.GithubComPortainerPortainerAPIHTTPHandlerSystemStatus
}
...
func (o *SystemUpgradeOK) GetPayload() *models_ee.GithubComPortainerPortainerAPIHTTPHandlerSystemStatus {
	return o.Payload
}
...
func (o *SystemUpgradeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.GithubComPortainerPortainerAPIHTTPHandlerSystemStatus)
