...
type PostEndpointGroupsParams struct {
	...
	*/
	Body *models_ee.EndpointgroupsEndpointGroupCreatePayload
...
func (o *PostEndpointGroupsParams) WithBody(body *models_ee.EndpointgroupsEndpointGroupCreatePayload) *PostEndpointGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post endpoint groups params
func (o *PostEndpointGroupsParams) SetBody(body *models_ee.EndpointgroupsEndpointGroupCreatePayload) {
	o.Body = body
}
