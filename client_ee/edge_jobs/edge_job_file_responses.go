...
type EdgeJobFileOK struct {
	Payload *models_ee.EdgejobsEdgeJobFileResponse
}
...
func (o *EdgeJobFileOK) GetPayload() *models_ee.EdgejobsEdgeJobFileResponse {
	return o.Payload
}
...
func (o *EdgeJobFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EdgejobsEdgeJobFileResponse)
