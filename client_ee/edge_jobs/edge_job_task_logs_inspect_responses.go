...
type EdgeJobTaskLogsInspectOK struct {
	Payload *models_ee.EdgejobsFileResponse
}
...
func (o *EdgeJobTaskLogsInspectOK) GetPayload() *models_ee.EdgejobsFileResponse {
	return o.Payload
}
...
func (o *EdgeJobTaskLogsInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EdgejobsFileResponse)
