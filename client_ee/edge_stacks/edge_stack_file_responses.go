...
type EdgeStackFileOK struct {
	Payload *models_ee.EdgestacksStackFileResponse
}
...
func (o *EdgeStackFileOK) GetPayload() *models_ee.EdgestacksStackFileResponse {
	return o.Payload
}
...
func (o *EdgeStackFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EdgestacksStackFileResponse)
