...
type EdgeStackUpdateParams struct {
	...
	/* Body.
	   ...
	   EdgeStack data
	*/
	Body *models_ee.EdgestacksUpdateEdgeStackPayload
...
func (o *EdgeStackUpdateParams) WithBody(body *models_ee.EdgestacksUpdateEdgeStackPayload) *EdgeStackUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge stack update params
func (o *EdgeStackUpdateParams) SetBody(body *models_ee.EdgestacksUpdateEdgeStackPayload) {
	o.Body = body
}
