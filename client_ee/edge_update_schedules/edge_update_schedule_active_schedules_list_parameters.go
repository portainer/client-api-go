...
type EdgeUpdateScheduleActiveSchedulesListParams struct {
	...
	*/
	Body *models_ee.EdgeupdateschedulesActiveSchedulePayload
...
func (o *EdgeUpdateScheduleActiveSchedulesListParams) WithBody(body *models_ee.EdgeupdateschedulesActiveSchedulePayload) *EdgeUpdateScheduleActiveSchedulesListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge update schedule active schedules list params
func (o *EdgeUpdateScheduleActiveSchedulesListParams) SetBody(body *models_ee.EdgeupdateschedulesActiveSchedulePayload) {
	o.Body = body
}
