...
type EdgeUpdateScheduleInspectOK struct {
	Payload *models_ee.EdgeupdateschedulesDecoratedUpdateSchedule
}
...
func (o *EdgeUpdateScheduleInspectOK) GetPayload() *models_ee.EdgeupdateschedulesDecoratedUpdateSchedule {
	return o.Payload
}
...
func (o *EdgeUpdateScheduleInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EdgeupdateschedulesDecoratedUpdateSchedule)
