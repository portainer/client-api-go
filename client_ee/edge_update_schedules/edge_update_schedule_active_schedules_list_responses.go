...
type EdgeUpdateScheduleActiveSchedulesListOK struct {
	Payload []*models_ee.TypesEndpointUpdateScheduleRelation
}
...
func (o *EdgeUpdateScheduleActiveSchedulesListOK) GetPayload() []*models_ee.TypesEndpointUpdateScheduleRelation {
	return o.Payload
}
