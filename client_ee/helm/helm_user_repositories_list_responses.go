...
type HelmUserRepositoriesListOK struct {
	Payload *models_ee.HelmHelmUserRepositoryResponse
}
...
func (o *HelmUserRepositoriesListOK) GetPayload() *models_ee.HelmHelmUserRepositoryResponse {
	return o.Payload
}
...
func (o *HelmUserRepositoriesListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.HelmHelmUserRepositoryResponse)
