...
type HelmUserRepositoryCreateOK struct {
	Payload *models_ee.PortainereeHelmUserRepository
}
...
func (o *HelmUserRepositoryCreateOK) GetPayload() *models_ee.PortainereeHelmUserRepository {
	return o.Payload
}
...
func (o *HelmUserRepositoryCreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PortainereeHelmUserRepository)
