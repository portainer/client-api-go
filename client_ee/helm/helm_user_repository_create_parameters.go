...
type HelmUserRepositoryCreateParams struct {
	...
	*/
	...
	/* Payload.
	   ...
	   Helm Repository
	*/
	Payload *models_ee.HelmAddHelmRepoURLPayload
...
func (o *HelmUserRepositoryCreateParams) WithPayload(payload *models_ee.HelmAddHelmRepoURLPayload) *HelmUserRepositoryCreateParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the helm user repository create params
func (o *HelmUserRepositoryCreateParams) SetPayload(payload *models_ee.HelmAddHelmRepoURLPayload) {
	o.Payload = payload
}
