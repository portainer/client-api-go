...
type HelmInstallParams struct {
	...
	*/
	...
	/* Payload.
	   ...
	   Chart details
	*/
	Payload *models_ee.HelmInstallChartPayload
...
func (o *HelmInstallParams) WithPayload(payload *models_ee.HelmInstallChartPayload) *HelmInstallParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the helm install params
func (o *HelmInstallParams) SetPayload(payload *models_ee.HelmInstallChartPayload) {
	o.Payload = payload
}
