...
type AuthenticateUserOK struct {
	Payload *models_ee.AuthAuthenticateResponse
}
...
func (o *AuthenticateUserOK) GetPayload() *models_ee.AuthAuthenticateResponse {
	return o.Payload
}
...
func (o *AuthenticateUserOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.AuthAuthenticateResponse)
