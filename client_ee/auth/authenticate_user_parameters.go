...
type AuthenticateUserParams struct {
	...
	*/
	Body *models_ee.AuthAuthenticatePayload
...
func (o *AuthenticateUserParams) WithBody(body *models_ee.AuthAuthenticatePayload) *AuthenticateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the authenticate user params
func (o *AuthenticateUserParams) SetBody(body *models_ee.AuthAuthenticatePayload) {
	o.Body = body
}
