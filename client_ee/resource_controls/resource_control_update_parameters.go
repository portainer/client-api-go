...
type ResourceControlUpdateParams struct {
	...
	*/
	Body *models_ee.ResourcecontrolsResourceControlUpdatePayload
...
func (o *ResourceControlUpdateParams) WithBody(body *models_ee.ResourcecontrolsResourceControlUpdatePayload) *ResourceControlUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the resource control update params
func (o *ResourceControlUpdateParams) SetBody(body *models_ee.ResourcecontrolsResourceControlUpdatePayload) {
	o.Body = body
}
