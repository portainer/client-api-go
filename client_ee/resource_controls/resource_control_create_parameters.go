...
type ResourceControlCreateParams struct {
	...
	*/
	Body *models_ee.ResourcecontrolsResourceControlCreatePayload
...
func (o *ResourceControlCreateParams) WithBody(body *models_ee.ResourcecontrolsResourceControlCreatePayload) *ResourceControlCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the resource control create params
func (o *ResourceControlCreateParams) SetBody(body *models_ee.ResourcecontrolsResourceControlCreatePayload) {
	o.Body = body
}
