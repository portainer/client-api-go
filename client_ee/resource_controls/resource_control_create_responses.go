...
type ResourceControlCreateOK struct {
	Payload *models_ee.PortainereeResourceControl
}
...
func (o *ResourceControlCreateOK) GetPayload() *models_ee.PortainereeResourceControl {
	return o.Payload
}
...
func (o *ResourceControlCreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PortainereeResourceControl)
