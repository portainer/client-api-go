...
type CustomTemplateCreateParams struct {
	...
	*/
	BodyRepository *models_ee.CustomtemplatesCustomTemplateFromGitRepositoryPayload

	/* BodyString.

	   Required when using method=string
	*/
	BodyString *models_ee.CustomtemplatesCustomTemplateFromFileContentPayload
...
func (o *CustomTemplateCreateParams) WithBodyRepository(bodyRepository *models_ee.CustomtemplatesCustomTemplateFromGitRepositoryPayload) *CustomTemplateCreateParams {
	o.SetBodyRepository(bodyRepository)
	return o
}

// SetBodyRepository adds the bodyRepository to the custom template create params
func (o *CustomTemplateCreateParams) SetBodyRepository(bodyRepository *models_ee.CustomtemplatesCustomTemplateFromGitRepositoryPayload) {
	o.BodyRepository = bodyRepository
}

// WithBodyString adds the bodyString to the custom template create params
func (o *CustomTemplateCreateParams) WithBodyString(bodyString *models_ee.CustomtemplatesCustomTemplateFromFileContentPayload) *CustomTemplateCreateParams {
	o.SetBodyString(bodyString)
	return o
}

// SetBodyString adds the bodyString to the custom template create params
func (o *CustomTemplateCreateParams) SetBodyString(bodyString *models_ee.CustomtemplatesCustomTemplateFromFileContentPayload) {
