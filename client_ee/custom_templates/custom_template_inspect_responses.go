...
type CustomTemplateInspectOK struct {
	Payload *models_ee.PortainereeCustomTemplate
}
...
func (o *CustomTemplateInspectOK) GetPayload() *models_ee.PortainereeCustomTemplate {
	return o.Payload
}
...
func (o *CustomTemplateInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PortainereeCustomTemplate)
