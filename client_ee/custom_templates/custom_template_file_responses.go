...
type CustomTemplateFileOK struct {
	Payload *models_ee.CustomtemplatesFileResponse
}
...
func (o *CustomTemplateFileOK) GetPayload() *models_ee.CustomtemplatesFileResponse {
	return o.Payload
}
...
func (o *CustomTemplateFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.CustomtemplatesFileResponse)
