...
type CustomTemplateUpdateParams struct {
	...
	/* Body.
	   ...
	   Template details
	*/
	Body *models_ee.CustomtemplatesCustomTemplateUpdatePayload
...
func (o *CustomTemplateUpdateParams) WithBody(body *models_ee.CustomtemplatesCustomTemplateUpdatePayload) *CustomTemplateUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the custom template update params
func (o *CustomTemplateUpdateParams) SetBody(body *models_ee.CustomtemplatesCustomTemplateUpdatePayload) {
	o.Body = body
}
