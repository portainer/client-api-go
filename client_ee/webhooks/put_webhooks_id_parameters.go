...
type PutWebhooksIDParams struct {
	...
	/* Body.
	   ...
	   Webhook data
	*/
	Body *models_ee.WebhooksWebhookUpdatePayload
...
func (o *PutWebhooksIDParams) WithBody(body *models_ee.WebhooksWebhookUpdatePayload) *PutWebhooksIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put webhooks ID params
func (o *PutWebhooksIDParams) SetBody(body *models_ee.WebhooksWebhookUpdatePayload) {
	o.Body = body
}
