...
type PutWebhooksIDReassignParams struct {
	...
	/* Body.
	   ...
	   Webhook data
	*/
	Body *models_ee.WebhooksWebhookReassignPayload
...
func (o *PutWebhooksIDReassignParams) WithBody(body *models_ee.WebhooksWebhookReassignPayload) *PutWebhooksIDReassignParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put webhooks ID reassign params
func (o *PutWebhooksIDReassignParams) SetBody(body *models_ee.WebhooksWebhookReassignPayload) {
	o.Body = body
}
