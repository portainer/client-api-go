...
type PostWebhooksParams struct {
	...
	/* Body.
	   ...
	   Webhook data
	*/
	Body *models_ee.WebhooksWebhookCreatePayload
...
func (o *PostWebhooksParams) WithBody(body *models_ee.WebhooksWebhookCreatePayload) *PostWebhooksParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post webhooks params
func (o *PostWebhooksParams) SetBody(body *models_ee.WebhooksWebhookCreatePayload) {
	o.Body = body
}
