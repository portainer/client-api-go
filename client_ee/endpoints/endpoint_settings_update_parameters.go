...
type EndpointSettingsUpdateParams struct {
	...
	*/
	Body *models_ee.EndpointsEndpointSettingsUpdatePayload
...
func (o *EndpointSettingsUpdateParams) WithBody(body *models_ee.EndpointsEndpointSettingsUpdatePayload) *EndpointSettingsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint settings update params
func (o *EndpointSettingsUpdateParams) SetBody(body *models_ee.EndpointsEndpointSettingsUpdatePayload) {
	o.Body = body
}
