...
type EndpointEdgeAsyncOK struct {
	Payload *models_ee.EndpointedgeEdgeAsyncResponse
}
...
func (o *EndpointEdgeAsyncOK) GetPayload() *models_ee.EndpointedgeEdgeAsyncResponse {
	return o.Payload
}
...
func (o *EndpointEdgeAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EndpointedgeEdgeAsyncResponse)
