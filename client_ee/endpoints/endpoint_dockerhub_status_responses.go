...
type EndpointDockerhubStatusOK struct {
	Payload *models_ee.EndpointsDockerhubStatusResponse
}
...
func (o *EndpointDockerhubStatusOK) GetPayload() *models_ee.EndpointsDockerhubStatusResponse {
	return o.Payload
}
...
func (o *EndpointDockerhubStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EndpointsDockerhubStatusResponse)
