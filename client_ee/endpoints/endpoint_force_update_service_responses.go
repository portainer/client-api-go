...
type EndpointForceUpdateServiceOK struct {
	Payload *models_ee.TypesServiceUpdateResponse
}
...
func (o *EndpointForceUpdateServiceOK) GetPayload() *models_ee.TypesServiceUpdateResponse {
	return o.Payload
}
...
func (o *EndpointForceUpdateServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.TypesServiceUpdateResponse)
