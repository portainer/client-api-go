...
type EndpointRegistryAccessParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.EndpointsRegistryAccessPayload
...
func (o *EndpointRegistryAccessParams) WithBody(body *models_ee.EndpointsRegistryAccessPayload) *EndpointRegistryAccessParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint registry access params
func (o *EndpointRegistryAccessParams) SetBody(body *models_ee.EndpointsRegistryAccessPayload) {
	o.Body = body
}
