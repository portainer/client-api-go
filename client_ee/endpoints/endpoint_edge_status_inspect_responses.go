...
type EndpointEdgeStatusInspectOK struct {
	Payload *models_ee.EndpointedgeEndpointEdgeStatusInspectResponse
}
...
func (o *EndpointEdgeStatusInspectOK) GetPayload() *models_ee.EndpointedgeEndpointEdgeStatusInspectResponse {
	return o.Payload
}
...
func (o *EndpointEdgeStatusInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EndpointedgeEndpointEdgeStatusInspectResponse)
