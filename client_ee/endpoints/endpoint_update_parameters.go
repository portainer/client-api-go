...
type EndpointUpdateParams struct {
	...
	*/
	Body *models_ee.EndpointsEndpointUpdatePayload
...
func (o *EndpointUpdateParams) WithBody(body *models_ee.EndpointsEndpointUpdatePayload) *EndpointUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint update params
func (o *EndpointUpdateParams) SetBody(body *models_ee.EndpointsEndpointUpdatePayload) {
	o.Body = body
}
