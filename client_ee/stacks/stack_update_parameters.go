...
type StackUpdateParams struct {
	...
	/* Body.
	   ...
	   Stack details
	*/
	Body *models_ee.StacksUpdateSwarmStackPayload
...
func (o *StackUpdateParams) WithBody(body *models_ee.StacksUpdateSwarmStackPayload) *StackUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack update params
func (o *StackUpdateParams) SetBody(body *models_ee.StacksUpdateSwarmStackPayload) {
	o.Body = body
}
