...
type StackCreateParams struct {
	...
	*/
	BodyComposeRepository *models_ee.StacksComposeStackFromGitRepositoryPayload

	/* BodyComposeString.

	   Required when using method=string and type=2
	*/
	BodyComposeString *models_ee.StacksComposeStackFromFileContentPayload

	/* BodyKubernetesRepository.

	   Required when using method=repository and type=3
	*/
	BodyKubernetesRepository *models_ee.StacksKubernetesGitDeploymentPayload

	/* BodyKubernetesString.

	   Required when using method=string and type=3
	*/
	BodyKubernetesString *models_ee.StacksKubernetesStringDeploymentPayload

	/* BodyKubernetesURL.

	   Required when using method=url and type=3
	*/
	BodyKubernetesURL *models_ee.StacksKubernetesManifestURLDeploymentPayload

	/* BodySwarmRepository.

	   Required when using method=repository and type=1
	*/
	BodySwarmRepository *models_ee.StacksSwarmStackFromGitRepositoryPayload

	/* BodySwarmString.

	   Required when using method=string and type=1
	*/
	BodySwarmString *models_ee.StacksSwarmStackFromFileContentPayload
...
func (o *StackCreateParams) WithBodyComposeRepository(bodyComposeRepository *models_ee.StacksComposeStackFromGitRepositoryPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyComposeRepository(bodyComposeRepository *models_ee.StacksComposeStackFromGitRepositoryPayload) {
	o.BodyComposeRepository = bodyComposeRepository
}

// WithBodyComposeString adds the bodyComposeString to the stack create params
func (o *StackCreateParams) WithBodyComposeString(bodyComposeString *models_ee.StacksComposeStackFromFileContentPayload) *StackCreateParams {
	o.SetBodyComposeString(bodyComposeString)
	return o
}

// SetBodyComposeString adds the bodyComposeString to the stack create params
func (o *StackCreateParams) SetBodyComposeString(bodyComposeString *models_ee.StacksComposeStackFromFileContentPayload) {
...
func (o *StackCreateParams) WithBodyKubernetesRepository(bodyKubernetesRepository *models_ee.StacksKubernetesGitDeploymentPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyKubernetesRepository(bodyKubernetesRepository *models_ee.StacksKubernetesGitDeploymentPayload) {
...
func (o *StackCreateParams) WithBodyKubernetesString(bodyKubernetesString *models_ee.StacksKubernetesStringDeploymentPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyKubernetesString(bodyKubernetesString *models_ee.StacksKubernetesStringDeploymentPayload) {
	o.BodyKubernetesString = bodyKubernetesString
}

// WithBodyKubernetesURL adds the bodyKubernetesURL to the stack create params
func (o *StackCreateParams) WithBodyKubernetesURL(bodyKubernetesURL *models_ee.StacksKubernetesManifestURLDeploymentPayload) *StackCreateParams {
	o.SetBodyKubernetesURL(bodyKubernetesURL)
	return o
}

// SetBodyKubernetesURL adds the bodyKubernetesUrl to the stack create params
func (o *StackCreateParams) SetBodyKubernetesURL(bodyKubernetesURL *models_ee.StacksKubernetesManifestURLDeploymentPayload) {
	o.BodyKubernetesURL = bodyKubernetesURL
}

// WithBodySwarmRepository adds the bodySwarmRepository to the stack create params
func (o *StackCreateParams) WithBodySwarmRepository(bodySwarmRepository *models_ee.StacksSwarmStackFromGitRepositoryPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodySwarmRepository(bodySwarmRepository *models_ee.StacksSwarmStackFromGitRepositoryPayload) {
	o.BodySwarmRepository = bodySwarmRepository
}

// WithBodySwarmString adds the bodySwarmString to the stack create params
func (o *StackCreateParams) WithBodySwarmString(bodySwarmString *models_ee.StacksSwarmStackFromFileContentPayload) *StackCreateParams {
	o.SetBodySwarmString(bodySwarmString)
	return o
}

// SetBodySwarmString adds the bodySwarmString to the stack create params
func (o *StackCreateParams) SetBodySwarmString(bodySwarmString *models_ee.StacksSwarmStackFromFileContentPayload) {
