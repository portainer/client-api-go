...
type StackFileInspectOK struct {
	Payload *models_ee.StacksStackFileResponse
}
...
func (o *StackFileInspectOK) GetPayload() *models_ee.StacksStackFileResponse {
	return o.Payload
}
...
func (o *StackFileInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.StacksStackFileResponse)
