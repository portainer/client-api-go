...
type StackMigrateParams struct {
	...
	*/
	Body *models_ee.StacksStackMigratePayload
...
func (o *StackMigrateParams) WithBody(body *models_ee.StacksStackMigratePayload) *StackMigrateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack migrate params
func (o *StackMigrateParams) SetBody(body *models_ee.StacksStackMigratePayload) {
	o.Body = body
}
