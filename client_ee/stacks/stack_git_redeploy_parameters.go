...
type StackGitRedeployParams struct {
	...
	*/
	Body *models_ee.StacksStackGitRedployPayload
...
func (o *StackGitRedeployParams) WithBody(body *models_ee.StacksStackGitRedployPayload) *StackGitRedeployParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack git redeploy params
func (o *StackGitRedeployParams) SetBody(body *models_ee.StacksStackGitRedployPayload) {
	o.Body = body
}
