...
type OpenAMTConfigureParams struct {
	...
	/* Body.
	   ...
	   OpenAMT Settings
	*/
	Body *models_ee.OpenamtOpenAMTConfigurePayload
...
func (o *OpenAMTConfigureParams) WithBody(body *models_ee.OpenamtOpenAMTConfigurePayload) *OpenAMTConfigureParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the open a m t configure params
func (o *OpenAMTConfigureParams) SetBody(body *models_ee.OpenamtOpenAMTConfigurePayload) {
	o.Body = body
}
