...
type GetEndpointsIDEdgeStacksStackIDOK struct {
	Payload *models_ee.EndpointedgeConfigResponse
}
...
func (o *GetEndpointsIDEdgeStacksStackIDOK) GetPayload() *models_ee.EndpointedgeConfigResponse {
	return o.Payload
}
...
func (o *GetEndpointsIDEdgeStacksStackIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.EndpointedgeConfigResponse)
