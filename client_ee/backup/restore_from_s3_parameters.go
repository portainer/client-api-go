...
type RestoreFromS3Params struct {
	...
	/* Body.
	   ...
	   S3 Location Payload
	*/
	Body *models_ee.BackupRestoreS3Settings
...
func (o *RestoreFromS3Params) WithBody(body *models_ee.BackupRestoreS3Settings) *RestoreFromS3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the restore from s3 params
func (o *RestoreFromS3Params) SetBody(body *models_ee.BackupRestoreS3Settings) {
	o.Body = body
}
