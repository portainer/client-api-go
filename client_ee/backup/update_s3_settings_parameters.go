...
type UpdateS3SettingsParams struct {
	...
	/* S3BackupSettings.
	   ...
	   S3 backup settings
	*/
	S3BackupSettings *models_ee.PortainereeS3BackupSettings
...
func (o *UpdateS3SettingsParams) WithS3BackupSettings(s3BackupSettings *models_ee.PortainereeS3BackupSettings) *UpdateS3SettingsParams {
	o.SetS3BackupSettings(s3BackupSettings)
	return o
}

// SetS3BackupSettings adds the s3BackupSettings to the update s3 settings params
func (o *UpdateS3SettingsParams) SetS3BackupSettings(s3BackupSettings *models_ee.PortainereeS3BackupSettings) {
