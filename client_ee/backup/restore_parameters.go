...
type RestoreParams struct {
	...
	*/
	RestorePayload *models_ee.BackupRestorePayload
...
func (o *RestoreParams) WithRestorePayload(restorePayload *models_ee.BackupRestorePayload) *RestoreParams {
	o.SetRestorePayload(restorePayload)
	return o
}

// SetRestorePayload adds the restorePayload to the restore params
func (o *RestoreParams) SetRestorePayload(restorePayload *models_ee.BackupRestorePayload) {
