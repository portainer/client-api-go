...
type BackupSettingsFetchOK struct {
	Payload *models_ee.PortainereeS3BackupSettings
}
...
func (o *BackupSettingsFetchOK) GetPayload() *models_ee.PortainereeS3BackupSettings {
	return o.Payload
}
...
func (o *BackupSettingsFetchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.PortainereeS3BackupSettings)
