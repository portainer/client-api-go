...
type BackupToS3Params struct {
	...
	/* Body.
	   ...
	   S3 backup settings
	*/
	Body *models_ee.BackupS3BackupPayload
...
func (o *BackupToS3Params) WithBody(body *models_ee.BackupS3BackupPayload) *BackupToS3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the backup to s3 params
func (o *BackupToS3Params) SetBody(body *models_ee.BackupS3BackupPayload) {
	o.Body = body
}
