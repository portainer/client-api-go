...
type BackupParams struct {
	...
	*/
	Body *models_ee.BackupBackupPayload
...
func (o *BackupParams) WithBody(body *models_ee.BackupBackupPayload) *BackupParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the backup params
func (o *BackupParams) SetBody(body *models_ee.BackupBackupPayload) {
	o.Body = body
}
