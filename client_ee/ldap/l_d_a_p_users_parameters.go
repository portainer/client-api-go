...
type LDAPUsersParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.LdapUsersPayload
...
func (o *LDAPUsersParams) WithBody(body *models_ee.LdapUsersPayload) *LDAPUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the l d a p users params
func (o *LDAPUsersParams) SetBody(body *models_ee.LdapUsersPayload) {
	o.Body = body
}
