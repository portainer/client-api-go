...
type LDAPTestLoginOK struct {
	Payload *models_ee.LdapTestLoginResponse
}
...
func (o *LDAPTestLoginOK) Error() string {
	return fmt.Sprintf("[POST /ldap/test][%d] lDAPTestLoginOK  %+v", 200, o.Payload)
}
...
func (o *LDAPTestLoginOK) GetPayload() *models_ee.LdapTestLoginResponse {
	return o.Payload
}
...
func (o *LDAPTestLoginOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.LdapTestLoginResponse)
