...
type LDAPAdminGroupsParams struct {
	...
	/* Body.
	   ...
	   LDAPSettings
	*/
	Body *models_ee.LdapAdminGroupsPayload
...
func (o *LDAPAdminGroupsParams) WithBody(body *models_ee.LdapAdminGroupsPayload) *LDAPAdminGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the l d a p admin groups params
func (o *LDAPAdminGroupsParams) SetBody(body *models_ee.LdapAdminGroupsPayload) {
	o.Body = body
}
