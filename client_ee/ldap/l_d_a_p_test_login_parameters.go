...
type LDAPTestLoginParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.LdapTestLoginPayload
...
func (o *LDAPTestLoginParams) WithBody(body *models_ee.LdapTestLoginPayload) *LDAPTestLoginParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the l d a p test login params
func (o *LDAPTestLoginParams) SetBody(body *models_ee.LdapTestLoginPayload) {
	o.Body = body
}
