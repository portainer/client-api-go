...
type LDAPGroupsParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ee.LdapGroupsPayload
...
func (o *LDAPGroupsParams) WithBody(body *models_ee.LdapGroupsPayload) *LDAPGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the l d a p groups params
func (o *LDAPGroupsParams) SetBody(body *models_ee.LdapGroupsPayload) {
	o.Body = body
}
