...
type SettingsPublicOK struct {
	Payload *models_ee.SettingsPublicSettingsResponse
}
...
func (o *SettingsPublicOK) GetPayload() *models_ee.SettingsPublicSettingsResponse {
	return o.Payload
}
...
func (o *SettingsPublicOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ee.SettingsPublicSettingsResponse)
