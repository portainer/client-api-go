...
type SettingsUpdateParams struct {
	...
	/* Body.
	   ...
	   New settings
	*/
	Body *models_ee.SettingsSettingsUpdatePayload
...
func (o *SettingsUpdateParams) WithBody(body *models_ee.SettingsSettingsUpdatePayload) *SettingsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the settings update params
func (o *SettingsUpdateParams) SetBody(body *models_ee.SettingsSettingsUpdatePayload) {
	o.Body = body
}
