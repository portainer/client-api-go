...
type TeamMembershipUpdateParams struct {
	...
	*/
	Body *models_ee.TeammembershipsTeamMembershipUpdatePayload
...
func (o *TeamMembershipUpdateParams) WithBody(body *models_ee.TeammembershipsTeamMembershipUpdatePayload) *TeamMembershipUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team membership update params
func (o *TeamMembershipUpdateParams) SetBody(body *models_ee.TeammembershipsTeamMembershipUpdatePayload) {
	o.Body = body
}
