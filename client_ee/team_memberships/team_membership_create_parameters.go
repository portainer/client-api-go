...
type TeamMembershipCreateParams struct {
	...
	*/
	Body *models_ee.TeammembershipsTeamMembershipCreatePayload
...
func (o *TeamMembershipCreateParams) WithBody(body *models_ee.TeammembershipsTeamMembershipCreatePayload) *TeamMembershipCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team membership create params
func (o *TeamMembershipCreateParams) SetBody(body *models_ee.TeammembershipsTeamMembershipCreatePayload) {
	o.Body = body
}
