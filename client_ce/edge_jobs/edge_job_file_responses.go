...
type EdgeJobFileOK struct {
	Payload *models_ce.EdgejobsEdgeJobFileResponse
}
...
func (o *EdgeJobFileOK) GetPayload() *models_ce.EdgejobsEdgeJobFileResponse {
	return o.Payload
}
...
func (o *EdgeJobFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EdgejobsEdgeJobFileResponse)
