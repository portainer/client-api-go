...
type EdgeJobTaskLogsInspectOK struct {
	Payload *models_ce.EdgejobsFileResponse
}
...
func (o *EdgeJobTaskLogsInspectOK) GetPayload() *models_ce.EdgejobsFileResponse {
	return o.Payload
}
...
func (o *EdgeJobTaskLogsInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EdgejobsFileResponse)
