...
type TeamMembershipUpdateParams struct {
	...
	*/
	Body *models_ce.TeammembershipsTeamMembershipUpdatePayload
...
// WithDefaults hydrates default values in the team membership update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamMembershipUpdateParams) WithDefaults() *TeamMembershipUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the team membership update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamMembershipUpdateParams) SetDefaults() {
...
func (o *TeamMembershipUpdateParams) WithBody(body *models_ce.TeammembershipsTeamMembershipUpdatePayload) *TeamMembershipUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team membership update params
func (o *TeamMembershipUpdateParams) SetBody(body *models_ce.TeammembershipsTeamMembershipUpdatePayload) {
	o.Body = body
}
