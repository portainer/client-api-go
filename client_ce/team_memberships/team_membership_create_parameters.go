...
type TeamMembershipCreateParams struct {
	...
	*/
	Body *models_ce.TeammembershipsTeamMembershipCreatePayload
...
func (o *TeamMembershipCreateParams) WithBody(body *models_ce.TeammembershipsTeamMembershipCreatePayload) *TeamMembershipCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team membership create params
func (o *TeamMembershipCreateParams) SetBody(body *models_ce.TeammembershipsTeamMembershipCreatePayload) {
	o.Body = body
}
