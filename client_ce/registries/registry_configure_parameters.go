...
type RegistryConfigureParams struct {
	...
	*/
	Body *models_ce.RegistriesRegistryConfigurePayload
...
func (o *RegistryConfigureParams) WithBody(body *models_ce.RegistriesRegistryConfigurePayload) *RegistryConfigureParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the registry configure params
func (o *RegistryConfigureParams) SetBody(body *models_ce.RegistriesRegistryConfigurePayload) {
	o.Body = body
}
