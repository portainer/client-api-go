...
type RegistryUpdateParams struct {
	...
	/* Body.
	   ...
	   Registry details
	*/
	Body *models_ce.RegistriesRegistryUpdatePayload
...
func (o *RegistryUpdateParams) WithBody(body *models_ce.RegistriesRegistryUpdatePayload) *RegistryUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the registry update params
func (o *RegistryUpdateParams) SetBody(body *models_ce.RegistriesRegistryUpdatePayload) {
	o.Body = body
}
