...
type HelmUserRepositoryCreateParams struct {
	...
	*/
	...
	/* Payload.
	   ...
	   Helm Repository
	*/
	Payload *models_ce.HelmAddHelmRepoURLPayload
...
func (o *HelmUserRepositoryCreateParams) WithPayload(payload *models_ce.HelmAddHelmRepoURLPayload) *HelmUserRepositoryCreateParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the helm user repository create params
func (o *HelmUserRepositoryCreateParams) SetPayload(payload *models_ce.HelmAddHelmRepoURLPayload) {
	o.Payload = payload
}
