...
type HelmUserRepositoryCreateOK struct {
	Payload *models_ce.PortainerHelmUserRepository
}
...
func (o *HelmUserRepositoryCreateOK) GetPayload() *models_ce.PortainerHelmUserRepository {
	return o.Payload
}
...
func (o *HelmUserRepositoryCreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.PortainerHelmUserRepository)
