...
type HelmInstallParams struct {
	...
	*/
	...
	/* Payload.
	   ...
	   Chart details
	*/
	Payload *models_ce.HelmInstallChartPayload
...
func (o *HelmInstallParams) WithPayload(payload *models_ce.HelmInstallChartPayload) *HelmInstallParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the helm install params
func (o *HelmInstallParams) SetPayload(payload *models_ce.HelmInstallChartPayload) {
	o.Payload = payload
}
