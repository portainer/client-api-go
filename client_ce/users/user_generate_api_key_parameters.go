...
type UserGenerateAPIKeyParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ce.UsersUserAccessTokenCreatePayload
...
func (o *UserGenerateAPIKeyParams) WithBody(body *models_ce.UsersUserAccessTokenCreatePayload) *UserGenerateAPIKeyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user generate API key params
func (o *UserGenerateAPIKeyParams) SetBody(body *models_ce.UsersUserAccessTokenCreatePayload) {
	o.Body = body
}
