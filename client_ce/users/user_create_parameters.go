...
type UserCreateParams struct {
	...
	/* Body.
	   ...
	   User details
	*/
	Body *models_ce.UsersUserCreatePayload
...
func (o *UserCreateParams) WithBody(body *models_ce.UsersUserCreatePayload) *UserCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user create params
func (o *UserCreateParams) SetBody(body *models_ce.UsersUserCreatePayload) {
	o.Body = body
}
