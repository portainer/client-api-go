...
type UserUpdateParams struct {
	...
	/* Body.
	   ...
	   User details
	*/
	Body *models_ce.UsersUserUpdatePayload
...
func (o *UserUpdateParams) WithBody(body *models_ce.UsersUserUpdatePayload) *UserUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user update params
func (o *UserUpdateParams) SetBody(body *models_ce.UsersUserUpdatePayload) {
	o.Body = body
}
