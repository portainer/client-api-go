...
type OpenAMTConfigureParams struct {
	...
	/* Body.
	   ...
	   OpenAMT Settings
	*/
	Body *models_ce.OpenamtOpenAMTConfigurePayload
...
func (o *OpenAMTConfigureParams) WithBody(body *models_ce.OpenamtOpenAMTConfigurePayload) *OpenAMTConfigureParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the open a m t configure params
func (o *OpenAMTConfigureParams) SetBody(body *models_ce.OpenamtOpenAMTConfigurePayload) {
	o.Body = body
}
