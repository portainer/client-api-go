...
type SettingsPublicOK struct {
	Payload *models_ce.SettingsPublicSettingsResponse
}
...
func (o *SettingsPublicOK) GetPayload() *models_ce.SettingsPublicSettingsResponse {
	return o.Payload
}
...
func (o *SettingsPublicOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.SettingsPublicSettingsResponse)
