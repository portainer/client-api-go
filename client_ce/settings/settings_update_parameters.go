...
type SettingsUpdateParams struct {
	...
	/* Body.
	   ...
	   New settings
	*/
	Body *models_ce.SettingsSettingsUpdatePayload
...
func (o *SettingsUpdateParams) WithBody(body *models_ce.SettingsSettingsUpdatePayload) *SettingsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the settings update params
func (o *SettingsUpdateParams) SetBody(body *models_ce.SettingsSettingsUpdatePayload) {
	o.Body = body
}
