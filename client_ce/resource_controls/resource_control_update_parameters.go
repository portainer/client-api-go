...
type ResourceControlUpdateParams struct {
	...
	*/
	Body *models_ce.ResourcecontrolsResourceControlUpdatePayload
...
func (o *ResourceControlUpdateParams) WithBody(body *models_ce.ResourcecontrolsResourceControlUpdatePayload) *ResourceControlUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the resource control update params
func (o *ResourceControlUpdateParams) SetBody(body *models_ce.ResourcecontrolsResourceControlUpdatePayload) {
	o.Body = body
}
