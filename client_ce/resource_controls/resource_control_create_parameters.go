...
type ResourceControlCreateParams struct {
	...
	*/
	Body *models_ce.ResourcecontrolsResourceControlCreatePayload
...
func (o *ResourceControlCreateParams) WithBody(body *models_ce.ResourcecontrolsResourceControlCreatePayload) *ResourceControlCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the resource control create params
func (o *ResourceControlCreateParams) SetBody(body *models_ce.ResourcecontrolsResourceControlCreatePayload) {
	o.Body = body
}
