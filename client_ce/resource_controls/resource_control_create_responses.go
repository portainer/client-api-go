...
type ResourceControlCreateOK struct {
	Payload *models_ce.PortainerResourceControl
}
...
func (o *ResourceControlCreateOK) GetPayload() *models_ce.PortainerResourceControl {
	return o.Payload
}
...
func (o *ResourceControlCreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.PortainerResourceControl)
