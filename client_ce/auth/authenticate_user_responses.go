...
type AuthenticateUserOK struct {
	Payload *models_ce.AuthAuthenticateResponse
}
...
func (o *AuthenticateUserOK) GetPayload() *models_ce.AuthAuthenticateResponse {
	return o.Payload
}
...
func (o *AuthenticateUserOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.AuthAuthenticateResponse)
