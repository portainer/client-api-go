...
type EndpointCreateGlobalKeyOK struct {
	Payload *models_ce.EndpointsEndpointCreateGlobalKeyResponse
}
...
func (o *EndpointCreateGlobalKeyOK) GetPayload() *models_ce.EndpointsEndpointCreateGlobalKeyResponse {
	return o.Payload
}
...
func (o *EndpointCreateGlobalKeyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EndpointsEndpointCreateGlobalKeyResponse)
