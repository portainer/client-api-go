...
type EndpointDockerhubStatusOK struct {
	Payload *models_ce.EndpointsDockerhubStatusResponse
}
...
func (o *EndpointDockerhubStatusOK) GetPayload() *models_ce.EndpointsDockerhubStatusResponse {
	return o.Payload
}
...
func (o *EndpointDockerhubStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EndpointsDockerhubStatusResponse)
