...
type EndpointEdgeStatusInspectOK struct {
	Payload *models_ce.EndpointedgeEndpointEdgeStatusInspectResponse
}
...
func (o *EndpointEdgeStatusInspectOK) GetPayload() *models_ce.EndpointedgeEndpointEdgeStatusInspectResponse {
	return o.Payload
}
...
func (o *EndpointEdgeStatusInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EndpointedgeEndpointEdgeStatusInspectResponse)
