...
type EndpointSettingsUpdateParams struct {
	...
	*/
	Body *models_ce.EndpointsEndpointSettingsUpdatePayload
...
func (o *EndpointSettingsUpdateParams) WithBody(body *models_ce.EndpointsEndpointSettingsUpdatePayload) *EndpointSettingsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint settings update params
func (o *EndpointSettingsUpdateParams) SetBody(body *models_ce.EndpointsEndpointSettingsUpdatePayload) {
	o.Body = body
}
