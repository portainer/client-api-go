...
type EndpointUpdateParams struct {
	...
	*/
	Body *models_ce.EndpointsEndpointUpdatePayload
...
func (o *EndpointUpdateParams) WithBody(body *models_ce.EndpointsEndpointUpdatePayload) *EndpointUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the endpoint update params
func (o *EndpointUpdateParams) SetBody(body *models_ce.EndpointsEndpointUpdatePayload) {
	o.Body = body
}
