...
type RestoreParams struct {
	...
	*/
	RestorePayload *models_ce.BackupRestorePayload
...
func (o *RestoreParams) WithRestorePayload(restorePayload *models_ce.BackupRestorePayload) *RestoreParams {
	o.SetRestorePayload(restorePayload)
	return o
}

// SetRestorePayload adds the restorePayload to the restore params
func (o *RestoreParams) SetRestorePayload(restorePayload *models_ce.BackupRestorePayload) {
