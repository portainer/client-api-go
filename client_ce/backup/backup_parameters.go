...
type BackupParams struct {
	...
	*/
	Body *models_ce.BackupBackupPayload
...
func (o *BackupParams) WithBody(body *models_ce.BackupBackupPayload) *BackupParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the backup params
func (o *BackupParams) SetBody(body *models_ce.BackupBackupPayload) {
	o.Body = body
}
