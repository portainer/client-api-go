...
type EdgeGroupCreateParams struct {
	...
	/* Body.
	   ...
	   EdgeGroup data
	*/
	Body *models_ce.EdgegroupsEdgeGroupCreatePayload
...
func (o *EdgeGroupCreateParams) WithBody(body *models_ce.EdgegroupsEdgeGroupCreatePayload) *EdgeGroupCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge group create params
func (o *EdgeGroupCreateParams) SetBody(body *models_ce.EdgegroupsEdgeGroupCreatePayload) {
	o.Body = body
}
