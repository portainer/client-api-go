...
type LDAPCheckParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ce.LdapCheckPayload
...
func (o *LDAPCheckParams) WithBody(body *models_ce.LdapCheckPayload) *LDAPCheckParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the l d a p check params
func (o *LDAPCheckParams) SetBody(body *models_ce.LdapCheckPayload) {
	o.Body = body
}
