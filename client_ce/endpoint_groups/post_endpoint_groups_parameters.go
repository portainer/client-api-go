...
type PostEndpointGroupsParams struct {
	...
	*/
	Body *models_ce.EndpointgroupsEndpointGroupCreatePayload
...
func (o *PostEndpointGroupsParams) WithBody(body *models_ce.EndpointgroupsEndpointGroupCreatePayload) *PostEndpointGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post endpoint groups params
func (o *PostEndpointGroupsParams) SetBody(body *models_ce.EndpointgroupsEndpointGroupCreatePayload) {
	o.Body = body
}
