...
type TeamCreateParams struct {
	...
	/* Body.
	   ...
	   details
	*/
	Body *models_ce.TeamsTeamCreatePayload
...
func (o *TeamCreateParams) WithBody(body *models_ce.TeamsTeamCreatePayload) *TeamCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team create params
func (o *TeamCreateParams) SetBody(body *models_ce.TeamsTeamCreatePayload) {
	o.Body = body
}
