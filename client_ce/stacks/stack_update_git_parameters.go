...
type StackUpdateGitParams struct {
	...
	*/
	Body *models_ce.StacksStackGitUpdatePayload
...
func (o *StackUpdateGitParams) WithBody(body *models_ce.StacksStackGitUpdatePayload) *StackUpdateGitParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack update git params
func (o *StackUpdateGitParams) SetBody(body *models_ce.StacksStackGitUpdatePayload) {
	o.Body = body
}
