...
type StackFileInspectOK struct {
	Payload *models_ce.StacksStackFileResponse
}
...
func (o *StackFileInspectOK) GetPayload() *models_ce.StacksStackFileResponse {
	return o.Payload
}
...
func (o *StackFileInspectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.StacksStackFileResponse)
