...
type StackUpdateParams struct {
	...
	/* Body.
	   ...
	   Stack details
	*/
	Body *models_ce.StacksUpdateSwarmStackPayload
...
func (o *StackUpdateParams) WithBody(body *models_ce.StacksUpdateSwarmStackPayload) *StackUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack update params
func (o *StackUpdateParams) SetBody(body *models_ce.StacksUpdateSwarmStackPayload) {
	o.Body = body
}
