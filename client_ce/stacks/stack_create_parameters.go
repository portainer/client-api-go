...
type StackCreateParams struct {
	...
	*/
	BodyComposeRepository *models_ce.StacksComposeStackFromGitRepositoryPayload

	/* BodyComposeString.

	   Required when using method=string and type=2
	*/
	BodyComposeString *models_ce.StacksComposeStackFromFileContentPayload

	/* BodyKubernetesRepository.

	   Required when using method=repository and type=3
	*/
	BodyKubernetesRepository *models_ce.StacksKubernetesGitDeploymentPayload

	/* BodyKubernetesString.

	   Required when using method=string and type=3
	*/
	BodyKubernetesString *models_ce.StacksKubernetesStringDeploymentPayload

	/* BodyKubernetesURL.

	   Required when using method=url and type=3
	*/
	BodyKubernetesURL *models_ce.StacksKubernetesManifestURLDeploymentPayload

	/* BodySwarmRepository.

	   Required when using method=repository and type=1
	*/
	BodySwarmRepository *models_ce.StacksSwarmStackFromGitRepositoryPayload

	/* BodySwarmString.

	   Required when using method=string and type=1
	*/
	BodySwarmString *models_ce.StacksSwarmStackFromFileContentPayload
...
func (o *StackCreateParams) WithBodyComposeRepository(bodyComposeRepository *models_ce.StacksComposeStackFromGitRepositoryPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyComposeRepository(bodyComposeRepository *models_ce.StacksComposeStackFromGitRepositoryPayload) {
	o.BodyComposeRepository = bodyComposeRepository
}

// WithBodyComposeString adds the bodyComposeString to the stack create params
func (o *StackCreateParams) WithBodyComposeString(bodyComposeString *models_ce.StacksComposeStackFromFileContentPayload) *StackCreateParams {
	o.SetBodyComposeString(bodyComposeString)
	return o
}

// SetBodyComposeString adds the bodyComposeString to the stack create params
func (o *StackCreateParams) SetBodyComposeString(bodyComposeString *models_ce.StacksComposeStackFromFileContentPayload) {
...
func (o *StackCreateParams) WithBodyKubernetesRepository(bodyKubernetesRepository *models_ce.StacksKubernetesGitDeploymentPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyKubernetesRepository(bodyKubernetesRepository *models_ce.StacksKubernetesGitDeploymentPayload) {
...
func (o *StackCreateParams) WithBodyKubernetesString(bodyKubernetesString *models_ce.StacksKubernetesStringDeploymentPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodyKubernetesString(bodyKubernetesString *models_ce.StacksKubernetesStringDeploymentPayload) {
	o.BodyKubernetesString = bodyKubernetesString
}

// WithBodyKubernetesURL adds the bodyKubernetesURL to the stack create params
func (o *StackCreateParams) WithBodyKubernetesURL(bodyKubernetesURL *models_ce.StacksKubernetesManifestURLDeploymentPayload) *StackCreateParams {
	o.SetBodyKubernetesURL(bodyKubernetesURL)
	return o
}

// SetBodyKubernetesURL adds the bodyKubernetesUrl to the stack create params
func (o *StackCreateParams) SetBodyKubernetesURL(bodyKubernetesURL *models_ce.StacksKubernetesManifestURLDeploymentPayload) {
	o.BodyKubernetesURL = bodyKubernetesURL
}

// WithBodySwarmRepository adds the bodySwarmRepository to the stack create params
func (o *StackCreateParams) WithBodySwarmRepository(bodySwarmRepository *models_ce.StacksSwarmStackFromGitRepositoryPayload) *StackCreateParams {
...
func (o *StackCreateParams) SetBodySwarmRepository(bodySwarmRepository *models_ce.StacksSwarmStackFromGitRepositoryPayload) {
	o.BodySwarmRepository = bodySwarmRepository
}

// WithBodySwarmString adds the bodySwarmString to the stack create params
func (o *StackCreateParams) WithBodySwarmString(bodySwarmString *models_ce.StacksSwarmStackFromFileContentPayload) *StackCreateParams {
	o.SetBodySwarmString(bodySwarmString)
	return o
}

// SetBodySwarmString adds the bodySwarmString to the stack create params
func (o *StackCreateParams) SetBodySwarmString(bodySwarmString *models_ce.StacksSwarmStackFromFileContentPayload) {
