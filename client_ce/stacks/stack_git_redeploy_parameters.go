...
type StackGitRedeployParams struct {
	...
	*/
	Body *models_ce.StacksStackGitRedployPayload
...
func (o *StackGitRedeployParams) WithBody(body *models_ce.StacksStackGitRedployPayload) *StackGitRedeployParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stack git redeploy params
func (o *StackGitRedeployParams) SetBody(body *models_ce.StacksStackGitRedployPayload) {
	o.Body = body
}
