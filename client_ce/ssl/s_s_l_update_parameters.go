...
type SSLUpdateParams struct {
	...
	/* Body.
	   ...
	   SSL Settings
	*/
	Body *models_ce.SslSslUpdatePayload
...
func (o *SSLUpdateParams) WithBody(body *models_ce.SslSslUpdatePayload) *SSLUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the s s l update params
func (o *SSLUpdateParams) SetBody(body *models_ce.SslSslUpdatePayload) {
	o.Body = body
}
