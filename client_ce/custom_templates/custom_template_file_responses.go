...
type CustomTemplateFileOK struct {
	Payload *models_ce.CustomtemplatesFileResponse
}
...
func (o *CustomTemplateFileOK) GetPayload() *models_ce.CustomtemplatesFileResponse {
	return o.Payload
}
...
func (o *CustomTemplateFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.CustomtemplatesFileResponse)
