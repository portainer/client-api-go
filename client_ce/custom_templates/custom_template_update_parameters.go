...
type CustomTemplateUpdateParams struct {
	...
	/* Body.
	   ...
	   Template details
	*/
	Body *models_ce.CustomtemplatesCustomTemplateUpdatePayload
...
func (o *CustomTemplateUpdateParams) WithBody(body *models_ce.CustomtemplatesCustomTemplateUpdatePayload) *CustomTemplateUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the custom template update params
func (o *CustomTemplateUpdateParams) SetBody(body *models_ce.CustomtemplatesCustomTemplateUpdatePayload) {
	o.Body = body
}
