...
type GetEndpointsIDEdgeStacksStackIDOK struct {
	Payload *models_ce.EndpointedgeConfigResponse
}
...
func (o *GetEndpointsIDEdgeStacksStackIDOK) GetPayload() *models_ce.EndpointedgeConfigResponse {
	return o.Payload
}
...
func (o *GetEndpointsIDEdgeStacksStackIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EndpointedgeConfigResponse)
