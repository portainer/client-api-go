...
type PutWebhooksIDParams struct {
	...
	/* Body.
	   ...
	   Webhook data
	*/
	Body *models_ce.WebhooksWebhookUpdatePayload
...
func (o *PutWebhooksIDParams) WithBody(body *models_ce.WebhooksWebhookUpdatePayload) *PutWebhooksIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put webhooks ID params
func (o *PutWebhooksIDParams) SetBody(body *models_ce.WebhooksWebhookUpdatePayload) {
	o.Body = body
}
