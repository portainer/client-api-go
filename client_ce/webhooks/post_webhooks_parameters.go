...
type PostWebhooksParams struct {
	...
	/* Body.
	   ...
	   Webhook data
	*/
	Body *models_ce.WebhooksWebhookCreatePayload
...
func (o *PostWebhooksParams) WithBody(body *models_ce.WebhooksWebhookCreatePayload) *PostWebhooksParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post webhooks params
func (o *PostWebhooksParams) SetBody(body *models_ce.WebhooksWebhookCreatePayload) {
	o.Body = body
}
