...
type TemplateFileParams struct {
	...
	/* Body.
	   ...
	   File details
	*/
	Body *models_ce.TemplatesFilePayload
...
func (o *TemplateFileParams) WithBody(body *models_ce.TemplatesFilePayload) *TemplateFileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the template file params
func (o *TemplateFileParams) SetBody(body *models_ce.TemplatesFilePayload) {
	o.Body = body
}
