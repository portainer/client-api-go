...
type EdgeStackUpdateParams struct {
	...
	/* Body.
	   ...
	   EdgeStack data
	*/
	Body *models_ce.EdgestacksUpdateEdgeStackPayload
...
func (o *EdgeStackUpdateParams) WithBody(body *models_ce.EdgestacksUpdateEdgeStackPayload) *EdgeStackUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge stack update params
func (o *EdgeStackUpdateParams) SetBody(body *models_ce.EdgestacksUpdateEdgeStackPayload) {
	o.Body = body
}
