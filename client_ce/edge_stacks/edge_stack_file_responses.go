...
type EdgeStackFileOK struct {
	Payload *models_ce.EdgestacksStackFileResponse
}
...
func (o *EdgeStackFileOK) GetPayload() *models_ce.EdgestacksStackFileResponse {
	return o.Payload
}
...
func (o *EdgeStackFileOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models_ce.EdgestacksStackFileResponse)
