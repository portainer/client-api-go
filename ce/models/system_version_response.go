...
//
// swagger:model system.versionResponse
type SystemVersionResponse struct {
	...
	// build
	Build *SystemBuildInfo `json:"build,omitempty"`
...
func (m *SystemVersionResponse) validateBuild(formats strfmt.Registry) error {
...
func (m *SystemVersionResponse) contextValidateBuild(ctx context.Context, formats strfmt.Registry) error {
