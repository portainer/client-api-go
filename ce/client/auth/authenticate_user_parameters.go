...
func (o *AuthenticateUserParams) WithBody(body *models.AuthAuthenticatePayload) *AuthenticateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the authenticate user params
func (o *AuthenticateUserParams) SetBody(body *models.AuthAuthenticatePayload) {
	o.Body = body
}
