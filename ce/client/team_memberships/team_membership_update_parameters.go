...
type TeamMembershipUpdateParams struct {
	...
	*/
	Body *models.TeammembershipsTeamMembershipUpdatePayload
...
func (o *TeamMembershipUpdateParams) WithBody(body *models.TeammembershipsTeamMembershipUpdatePayload) *TeamMembershipUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the team membership update params
func (o *TeamMembershipUpdateParams) SetBody(body *models.TeammembershipsTeamMembershipUpdatePayload) {
	o.Body = body
}
