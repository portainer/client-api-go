...
func (m *V1Service) validateManagedFields(formats strfmt.Registry) error {
...
func (m *V1Service) validateOwnerReferences(formats strfmt.Registry) error {
...
func (m *V1Service) contextValidateManagedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1Service) contextValidateOwnerReferences(ctx context.Context, formats strfmt.Registry) error {
