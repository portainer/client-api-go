...
func (m *V1beta1PodMetrics) validateManagedFields(formats strfmt.Registry) error {
...
func (m *V1beta1PodMetrics) validateOwnerReferences(formats strfmt.Registry) error {
...
func (m *V1beta1PodMetrics) contextValidateManagedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1beta1PodMetrics) contextValidateOwnerReferences(ctx context.Context, formats strfmt.Registry) error {
