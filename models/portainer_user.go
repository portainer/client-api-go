...
type PortainerUser struct {
	...
	// theme settings
	ThemeSettings *PortainerUserThemeSettings `json:"themeSettings,omitempty"`
...
func (m *PortainerUser) validateThemeSettings(formats strfmt.Registry) error {
...
func (m *PortainerUser) contextValidateThemeSettings(ctx context.Context, formats strfmt.Registry) error {
