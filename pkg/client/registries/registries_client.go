...
type ClientService interface {
	...
	RegistryPing(params *RegistryPingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegistryPingOK, error)
...
/*
	RegistryPing tests registry connection

	Test connection to a registry with provided credentials

**Access policy**: authenticated
*/
func (a *Client) RegistryPing(params *RegistryPingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegistryPingOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewRegistryPingParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "RegistryPing",
		Method:             "POST",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &RegistryPingReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*RegistryPingOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for RegistryPing: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
