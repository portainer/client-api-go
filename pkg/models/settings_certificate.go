...
// SettingsCertificate settings certificate
//
// swagger:model settings.Certificate
type SettingsCertificate struct {
	...
	// issuer
	Issuer *SettingsName `json:"Issuer,omitempty"`
	...
	// public key
	PublicKey *SettingsPublicKey `json:"PublicKey,omitempty"`
	...
	// subject
	Subject *SettingsName `json:"Subject,omitempty"`
...
// Validate validates this settings certificate
func (m *SettingsCertificate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SettingsCertificate) validateIssuer(formats strfmt.Registry) error {
...
func (m *SettingsCertificate) validatePublicKey(formats strfmt.Registry) error {
...
func (m *SettingsCertificate) validateSubject(formats strfmt.Registry) error {
...
// ContextValidate validate this settings certificate based on the context it is used
func (m *SettingsCertificate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SettingsCertificate) contextValidateIssuer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SettingsCertificate) contextValidatePublicKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SettingsCertificate) contextValidateSubject(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SettingsCertificate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SettingsCertificate) UnmarshalBinary(b []byte) error {
	var res SettingsCertificate
