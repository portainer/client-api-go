...
/* DockerHubInspectParams contains all the parameters to send to the API endpoint
   for the docker hub inspect operation.
...
// WithDefaults hydrates default values in the docker hub inspect params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DockerHubInspectParams) WithDefaults() *DockerHubInspectParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the docker hub inspect params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DockerHubInspectParams) SetDefaults() {
