...
func (o *EdgeJobCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /edge_jobs] EdgeJobCreate", response, response.Code())
	}
}
...
// Code gets the status code for the edge job create o k response
func (o *EdgeJobCreateOK) Code() int {
	return 200
}

func (o *EdgeJobCreateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /edge_jobs][%d] edgeJobCreateOK %s", 200, payload)
}
...
// Code gets the status code for the edge job create internal server error response
func (o *EdgeJobCreateInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the edge job create service unavailable response
func (o *EdgeJobCreateServiceUnavailable) Code() int {
	return 503
}
