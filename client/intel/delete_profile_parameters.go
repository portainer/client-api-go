...
// WithID adds the id to the delete profile params
func (o *DeleteProfileParams) WithID(id int64) *DeleteProfileParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete profile params
func (o *DeleteProfileParams) SetID(id int64) {
	o.ID = id
}
