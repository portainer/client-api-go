...
func (o *StackCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /stacks] StackCreate", response, response.Code())
	}
}
...
// Code gets the status code for the stack create o k response
func (o *StackCreateOK) Code() int {
	return 200
}
...
// Code gets the status code for the stack create bad request response
func (o *StackCreateBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the stack create internal server error response
func (o *StackCreateInternalServerError) Code() int {
	return 500
}
