...
func (o *EdgeStackCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /edge_stacks] EdgeStackCreate", response, response.Code())
	}
}
...
// Code gets the status code for the edge stack create o k response
func (o *EdgeStackCreateOK) Code() int {
	return 200
}
...
// Code gets the status code for the edge stack create internal server error response
func (o *EdgeStackCreateInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the edge stack create service unavailable response
func (o *EdgeStackCreateServiceUnavailable) Code() int {
	return 503
}
