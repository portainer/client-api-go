...
/* TeamMembershipDeleteParams contains all the parameters to send to the API endpoint
   for the team membership delete operation.
...
// WithDefaults hydrates default values in the team membership delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamMembershipDeleteParams) WithDefaults() *TeamMembershipDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the team membership delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamMembershipDeleteParams) SetDefaults() {
