...
func (o *GetLeaderOK) Error() string {
	return fmt.Sprintf("[GET /nomad/endpoints/{endpointID}/status][%d] getLeaderOK ", 200)
}
...
func (o *GetLeaderNotFound) Error() string {
	return fmt.Sprintf("[GET /nomad/endpoints/{endpointID}/status][%d] getLeaderNotFound ", 404)
}
...
func (o *GetLeaderInternalServerError) Error() string {
	return fmt.Sprintf("[GET /nomad/endpoints/{endpointID}/status][%d] getLeaderInternalServerError ", 500)
}
